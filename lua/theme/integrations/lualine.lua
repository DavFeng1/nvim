...
--
-- vim.api.nvim_set_hl(0, 'lualine_c_progress_normal', { fg = colors.black, bg = colors.lualine_background })
--
-- vim.api.nvim_set_hl(0, 'lualine_x_10_normal', { fg = colors.black, bg = colors.lualine_background })
-- vim.api.nvim_set_hl(0, 'lualine_x_branch_normal', { fg = colors.black, bg = colors.lualine_background })
