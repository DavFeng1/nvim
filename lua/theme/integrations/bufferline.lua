...
vim.api.nvim_set_hl(0, 'BufferLineSeparator', { fg = colors.background,  bg = colors.background2 })
...
vim.api.nvim_set_hl(0, 'BufferLineSeparatorVisible', { bg = colors.background2 })
...
-- Selected
vim.api.nvim_set_hl(0, 'BufferLineSeparatorSelected', { bg = colors.background1 })
