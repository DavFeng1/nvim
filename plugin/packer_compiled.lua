...
_G.packer_plugins = {
  ...
  ["nvim-dap-vscode-js"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-dap-vscode-js",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/davidfeng/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  ["vscode-js-debug"] = {
    loaded = false,
    needs_bufread = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/vscode-js-debug",
